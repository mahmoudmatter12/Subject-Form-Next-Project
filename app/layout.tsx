  ...
  return (
    ...
    >
      <html lang="en" className={inter.className}>
        <body
          className="min-h-screen bg-gradient-to-br from-gray-900 via-cyan-800 to-gray-900"
        ...
        >
          <SocketProvider>
            ...
            {/* Main Content */}
            <AccountMenu />
            <main className="container mx-auto md:px-6  pt-12 pb-12">{children}</main>
              ...
              <div className="container mx-auto px-6">
                <div className="flex flex-col md:flex-row justify-between items-center">
                  ...
                  <div className="flex space-x-6">
                    <a href="/about" className="text-gray-400 hover:text-sky-400 transition-colors">
                      About
                    </a>
                ...
                <div className="mt-6 pt-6 border-t border-gray-800 text-center text-gray-500 text-sm">
                  <p>
                    © {typeof window !== "undefined" ? new Date().getFullYear() : "2023"} Student Union Portal. All
                    rights reserved.
                  </p>
                </div>
              </div>
